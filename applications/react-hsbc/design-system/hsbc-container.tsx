export default function HsbcContainer(props: {
    title?: string,
    instruction?: string,
                ...
                {props.title && <div className="container_CsI53 marginBottom3_cHPnK" data-component="PageHeader">
                    <div className="grid_ghPKb clearfix_hhLma">
                        <div className="cell_uuvmm size12_bNMEu"><div className="textContainer_kIkGx paddingBottom3_fOs8E">
                            <h1 className="heading_GSFKs marginBottom2_EeogK h1_iZ4nN fontLight_SlHz2 fontSize6_EWN8V noMargin_Vq5Wm largerMarginInLargeDevice_M5t6a" tabIndex={-1}>
                                {props.title}
                            </h1>
