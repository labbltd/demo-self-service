...
export function BOIBackButton(props: {
    ...
    return <button onClick={props.onClick} data-testid="button" type="button" tabIndex={0} data-react-aria-pressable="true" aria-label="Back to previous page of the form" className="sc-hrphqP jnHmVK" data-rac="" id="react-aria8716564887-:r2e:">
        <div className="sc-jyqoAZ iJCXBt"></div>
        <div className="sc-cnVfeA cRyRxH">
            <div className="sc-eJZSpO llFwYq">
                <span className="sc-EZsnr vVHbt">
...
export function BOINextButton(props: {
    ...
    return <button onClick={props.onClick} data-testid="button" type="button" data-react-aria-pressable="true" aria-label="Continue to next page of the form" className="sc-hrphqP jnHmVK" data-rac="" id="react-aria8716564887-:rc:">
